...
const (
	...
	LogTradeSlotPublishSuccess        = "trade slot publish success: product_id=%d slot_count=%d"
	LogTradeSlotLockSuccess           = "trade slot lock success: slot_id=%d order_id=%d product_id=%d"
	LogTradeSlotLockFailed            = "trade slot lock failed: slot_id=%d buyer=%d error=%v"
	LogTradeSlotReleaseSuccess        = "trade slot release success: slot_id=%d order_id=%d"
	LogTradeSlotListSuccess           = "trade slot list success: product_id=%d available=%d total=%d"
)
