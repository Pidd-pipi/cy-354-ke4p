...
const (
	...
	LogProductSlotPublishSuccess      = "product slots publish success: product_id=%d count=%d"
	LogProductSlotPublishFailed       = "product slots publish failed: product_id=%d error=%v"
	LogProductSlotOccupySuccess       = "product slot occupy success: slot_id=%d product_id=%d order_id=%d"
	LogProductSlotOccupyFailed        = "product slot occupy failed: slot_id=%d product_id=%d order_id=%d error=%v"
	LogProductSlotReleasedSuccess     = "product slot released success: slot_id=%d product_id=%d order_id=%d"
	LogProductSlotLockedSuccess       = "product slots locked success: product_id=%d count=%d"
)
